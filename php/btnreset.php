...
function biz_logic_wp_custom_get_btnreset_control_options_arr($the_action_cmd, $the_control_fields_arr) {
    $html_str = "";
        ...
        <div id='div-control-options-tabs' >
            ...
            <div id='tabs-general' >
                ...
                <div class='div-any-form-row' >
                    <div class='div-any-form-cell lbl w105' >
                        " . _x("Text:", "Reset button options button text label", "wp-any-form") . "
                    </div>
                    <div class='div-any-form-cell' >
                        <input id='txt_btnreset_text' class='txt_control_options' placeholder='" . _x("Enter text", "Reset button options button text placeholder", "wp-any-form") . "' value='" . $the_text . "' />
                        &nbsp;
                        " . ASTERISK_HTML_STR . "
                    </div>  
                </div>     
            ...
            <div id='tabs-style' >
                ...
                <div class='div-any-form-row' >
                    ...
                    <div class='div-any-form-cell' >
                        <input id='txt_btnreset_font_size' class='txt_control_options txt_default_font_size numbers_only' value='" . $the_font_size . "' />
                        &nbsp;
                        px
                    </div>
                </div>
                <div class='div-any-form-row' >
                    ...
                    <div class='div-any-form-cell' >
                        " . biz_logic_wp_custom_get_font_weight_ddl_html_str("", "ddl_form_btnreset_font_weight", $the_font_weight) . "
                    </div>
                </div>
                <div class='div-any-form-row' >
                    <div class='div-any-form-cell lbl w165' >
                    ...
                    <div class='div-any-form-cell' >
                        <input id='txt_btnreset_font_colour' class='txt_control_options txt_font_colour' value='" . $the_font_colour . "' />
                        &nbsp;
...
function biz_logic_wp_custom_get_btnreset_html($the_control_fields_arr) {
	$html_str = "";
    $the_btn_id = $the_control_fields_arr["the_btn_id"];    
	$the_text = $the_control_fields_arr["the_text"];    
    $the_custom_css_class = $the_control_fields_arr["the_custom_css_class"];
    $html_str .= "<input id='" . $the_btn_id . "' class='div-wp-any-form-btnreset";
